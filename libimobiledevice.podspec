...
s.platform = :osx, '10.7' 
s.source = { :git => "https://github.com/Clstroud/libimobiledevice.git", :tag => "#{s.version}"}
...
s.xcconfig = {"GCC_PREPROCESSOR_DEFINITIONS" => 'HAVE_OPENSSL HAVE_VASPRINTF HAVE_ASPRINTF', "HEADER_SEARCH_PATHS" => '"${PODS_ROOT}/libplist/include/" "${PODS_ROOT}/libimobiledevice/common/"'}
